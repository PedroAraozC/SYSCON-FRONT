...
import ModalMetodoDePago from "../components/MetodosDePago/ModalMetodoDePago";
import AddIcon from "@mui/icons-material/Add";

import {
  getMetodosDePago,
  getMetodosDePagoAdmin,
  crearMetodoDePago,
  actualizarMetodoDePago,
  eliminarMetodoDePago,
} from "../components/MetodosDePago/funciones";
...
export default function MetodosDePago() {
  ...
  const [selectedMetodoDePago, setSelectedMetodoDePago] = useState(null);
  ...
  const handleNuevo = () => {
    setSelectedMetodoDePago(null);
    setOpenModal(true);
  };

  const handleEditar = (metodoDePago) => {
    setSelectedMetodoDePago(metodoDePago);
    setOpenModal(true);
  };

  const handleSave = async (data) => {
    try {
      if (selectedMetodoDePago) {
        await actualizarMetodoDePago(selectedMetodoDePago.id_metodo_pago, data);
      } else {
        await crearMetodoDePago(data);
      }
  ...
  return (
    <MainLayout>
      ...
      <ModalMetodoDePago
        ...
        onSave={handleSave}
        metodo_pago={selectedMetodoDePago}
      />
    </MainLayout>
  );
}
